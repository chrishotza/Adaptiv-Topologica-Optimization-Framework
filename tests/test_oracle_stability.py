from experiments.run_oracle_stability import summarize_corpus_stability, summarize_graph_stability
...
def test_summarize_graph_stability_tracks_seed_consensus():
    ...
    assert summary["oracle_absolute_margin"] == 1.0
...
def test_summarize_corpus_stability_counts_oracle_diversity():
    ...
    assert summary["mean_seed_consensus"] == 5 / 6
